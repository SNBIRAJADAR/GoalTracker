...
<head>
  ...
  <link rel="stylesheet" href="goals.php">
  <title>Goal Tracker</title>
</head>

<body class="body">
  <div class="image">
    <img class="home_image" src='./bg3.jpg' alt="" />
  </div>
  <div id="container">
    <h1> <strong>NEW GOAL</strong> </h1>
    <form action="insert_goal.php" method="post">
      ...
      <textarea name="text" id="text" placeholder="Set your goal"></textarea>
